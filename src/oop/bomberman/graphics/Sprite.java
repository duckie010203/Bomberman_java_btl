...
public class Sprite {
     ...
     * Boss.
     */
    public static Sprite boss_up = new Sprite(16, 0, 0, SpriteSheet.tiles, 12, 16);
    public static Sprite boss_down = new Sprite(16, 2, 0, SpriteSheet.tiles, 12, 15);
    public static Sprite boss_left = new Sprite(16, 3, 0, SpriteSheet.tiles, 10, 15);
    public static Sprite boss_right = new Sprite(16, 1, 0, SpriteSheet.tiles, 10, 16);

    public static Sprite boss_up_1 = new Sprite(16, 0, 1, SpriteSheet.tiles, 12, 16);
    public static Sprite boss_up_2 = new Sprite(16, 0, 2, SpriteSheet.tiles, 12, 15);

    public static Sprite boss_down_1 = new Sprite(16, 2, 1, SpriteSheet.tiles, 12, 15);
    public static Sprite boss_down_2 = new Sprite(16, 2, 2, SpriteSheet.tiles, 12, 16);

    public static Sprite boss_left_1 = new Sprite(16, 3, 1, SpriteSheet.tiles, 11, 16);
    public static Sprite boss_left_2 = new Sprite(16, 3, 2, SpriteSheet.tiles, 12 ,16);

    public static Sprite boss_right_1 = new Sprite(16, 1, 1, SpriteSheet.tiles, 11, 16);
    public static Sprite boss_right_2 = new Sprite(16, 1, 2, SpriteSheet.tiles, 12, 16);

    public static Sprite boss_dead1 = new Sprite(16, 4, 2, SpriteSheet.tiles, 14, 16);
    public static Sprite boss_dead2 = new Sprite(16, 5, 2, SpriteSheet.tiles, 13, 15);
    public static Sprite boss_dead3 = new Sprite(16, 6, 2, SpriteSheet.tiles, 16, 16);
